...
cat = Cat.new(user: user2, name: "Lily", personality: "Lily, with fur as white as freshly fallen snow and eyes as bright as twinkling stars, is our little angel. Whether she's chasing butterflies or snuggled up in a warm blanket, Lily's innocence and purity bring joy to our hearts.", age: Faker::Number.within(range: 1..19), breed: Faker::Creature::Cat.breed, address: "Wipkingen, Zurich")
...
cat = Cat.new(user: user2, name: "Jess", personality: "With a fur coat that shimmers like moonlight on a still lake and eyes that flicker with the wisdom of the ages, this cat is a creature of mystery and magic. Whether it's communing with the spirits of its ancestors in the dead of night or summoning thunderstorms with a flick of its tail, this feline sorcerer is a force to be reckoned with.", age: Faker::Number.within(range: 1..19), breed: Faker::Creature::Cat.breed, address: "Zurich")
...
cat = Cat.new(user: user2, name: "Henry", personality: "This eccentric little ball of fur is a veritable tornado of chaos and confusion, leaving a trail of overturned furniture and misplaced socks in its wake. Whether it's practicing its interpretive dance routines in the middle of the living room or conducting elaborate experiments with gravity from the top of the staircase, this cat's boundless energy and insatiable curiosity know no bounds.", age: Faker::Number.within(range: 1..19), breed: Faker::Creature::Cat.breed, address: "Norwich")
