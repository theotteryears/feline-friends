...
cat = Cat.new(user: user2, name: "Milo", personality: "With fur as fluffy as a cloud and eyes that gleam like polished amber, Milo is our cuddly companion. Milo fills our home with warmth and love.", age: Faker::Number.within(range: 1..19), breed: Faker::Creature::Cat.breed, address: "London")
...
cat = Cat.new(user: user2, name: "Sophie", personality: "Meet Sophie, the elegant queen of our household. Her fur, as sleek as satin, and eyes, as green as the forest, radiate grace and charm.", age: Faker::Number.within(range: 1..19), breed: Faker::Creature::Cat.breed, address: "Altstetten, Zurich")
...
cat = Cat.new(user: user2, name: "Diego", personality: "Likes: Eating and sleeping - Dislikes: Being left alone for too long", age: Faker::Number.within(range: 1..19), breed: Faker::Creature::Cat.breed, address: "Hardbrücke, Zurich")
...
cat = Cat.new(user: user2, name: "David", personality: "David, the mighty lion of our household, has fur as majestic as a mane and eyes that burn with fiery intensity.", age: Faker::Number.within(range: 1..19), breed: Faker::Creature::Cat.breed, address: "Enge, Zurich")
...
cat = Cat.new(user: user2, name: "Sir Pouncealot", personality: "He just will not stop jumping around. I hope you have some energy.", age: Faker::Number.within(range: 1..19), breed: Faker::Creature::Cat.breed, address: "Wiedikon, Zurich")
...
cat = Cat.new(user: user2, name: "Lily", personality: "Lily, with fur as white as freshly fallen snow and eyes as bright as twinkling stars, is our little angel.", age: Faker::Number.within(range: 1..19), breed: Faker::Creature::Cat.breed, address: "Wipkingen, Zurich")
...
cat = Cat.new(user: user2, name: "Sosuke", personality: "This enigmatic creature is a master of disguise, blending seamlessly into its surroundings like a chameleon in a rainbow factory.", age: Faker::Number.within(range: 1..19), breed: Faker::Creature::Cat.breed, address: "Hove")
...
cat = Cat.new(user: user2, name: "Jean-Claude", personality: "With a fur coat that rivals the fluffiness of a cumulus cloud and a penchant for avant-garde interpretive dance, this cat is a true eccentric.", age: Faker::Number.within(range: 1..19), breed: Faker::Creature::Cat.breed, address: "Paris")
...
cat = Cat.new(user: user2, name: "Rubine", personality: "This regal feline aristocrat is a creature of refinement and sophistication, conducting itself with the grace and elegance of a prima ballerina.", age: Faker::Number.within(range: 1..19), breed: Faker::Creature::Cat.breed, address: "Schauenbergstrasse 6, 8400 Winterthur")
...
cat = Cat.new(user: user2, name: "Carlos", personality: "With fur as vibrant as a rainbow and eyes that shimmer like precious gemstones, this flamboyant feline is a true eccentric.", age: Faker::Number.within(range: 1..19), breed: Faker::Creature::Cat.breed, address: "Salisbury Road, Hove")
...
cat = Cat.new(user: user2, name: "Flower", personality: "This mischievous little rascal is a master of disguise, donning elaborate costumes and assuming a variety of personas with ease.", age: Faker::Number.within(range: 1..19), breed: Faker::Creature::Cat.breed, address: "4 Keppel Street, Coventry")
...
cat = Cat.new(user: user2, name: "Francis", personality: "This curious little creature is a true connoisseur of the absurd, delighting in the absurdities of everyday life with an infectious enthusiasm.", age: Faker::Number.within(range: 1..19), breed: Faker::Creature::Cat.breed, address: "Geneva")
...
cat = Cat.new(user: user2, name: "Tuna", personality: "With fur as soft as a whisper and eyes that gleam with an inscrutable wisdom, this enigmatic feline is like a sage of the shadows.", age: Faker::Number.within(range: 1..19), breed: Faker::Creature::Cat.breed, address: "Brussels")
...
cat = Cat.new(user: user2, name: "Jess", personality: "With a fur coat that shimmers like moonlight on a still lake and eyes that flicker with the wisdom of the ages, this cat is a creature of mystery and magic.", age: Faker::Number.within(range: 1..19), breed: Faker::Creature::Cat.breed, address: "Zurich")
...
cat = Cat.new(user: user2, name: "Garlic", personality: "With fur that seems to emit a faint glow in the dark and eyes that shimmer like distant galaxies, this ethereal feline is like a creature from a surreal dream.", age: Faker::Number.within(range: 1..19), breed: Faker::Creature::Cat.breed, address: "Luxembourg")
...
cat = Cat.new(user: user2, name: "Henry", personality: "This eccentric little ball of fur is a veritable tornado of chaos and confusion, leaving a trail of overturned furniture and misplaced socks in its wake.", age: Faker::Number.within(range: 1..19), breed: Faker::Creature::Cat.breed, address: "Norwich")
